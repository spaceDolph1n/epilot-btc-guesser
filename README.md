...
**Live Demo:** [https://epilot-btc-guesser-pearl.vercel.app/](https://epilot-btc-guesser-pearl.vercel.app/)
...
- **Deployment**: Hosted on **Vercel** utilizing Edge Middleware for identity persistence.
- **CI/CD**: Automated via **GitHub Actions** with quality gates for Linting, TypeScript, and Vitest/Playwright tests.
